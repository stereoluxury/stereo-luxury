...
export const GridTileImage: React.FC<Props> = ({
  ...
  return (
    <div
      className={clsx(
        'group flex h-full w-full items-center justify-center overflow-hidden border bg-white hover:border-primary-foreground dark:bg-black',
        {
          'border-2 border-primary-foreground': active,
